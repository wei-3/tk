<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/owner\detail.html";i:1507287628;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<form action="" method="post" class="form-horizontal">
	<div class="form-item">
		<span class="item-label">会员姓名：<span class="check-tips"><?php echo $info['vip_name']; ?></span></span>
	</div>
	<div class="form-item">
		<span class="item-label">业主姓名：<span class="check-tips"><?php echo $info['name']; ?></span></span>
	</div>
	<div class="form-item">
		<span class="item-label">业主电话：<span class="check-tips"><?php echo $info['tel']; ?></span></span>
	</div>
	<div class="form-item">
		<span class="item-label">住户编号：<span class="check-tips"><?php echo $info['number']; ?></span></span>
	</div>
	<div class="form-item">
		<span class="item-label">小区名字：<span class="check-tips"><?php echo $info['cell_name']; ?></span></span>
	</div>
	<div class="form-item">
		<span class="item-label">身份证：<span class="check-tips"><?php echo $info['id_card']; ?></span></span>
	</div>
	<div class="form-item">
	...
	<div class="form-item">
		<span class="item-label">认证时间：<span class="check-tips"><?php echo $info['create_time']; ?></span></span>
	</div>
</form>
