<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/notice\notice.html";i:1507447424;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    var loadPage=function (no) {
        $.get("<?php echo url('Notice/ajaxpage'); ?>",{id:<?php echo $id; ?>,page:no},function (data) {
            $(".btn_load").remove();
            $('#content').append(data);
        })
    }
