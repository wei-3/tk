<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/property\active_edit.html";i:1507185730;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<body>
	...
	<form action="<?php echo url(); ?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			...
			<div class="controls">
				<input type="text" class="text input-large" name="active_name" value="<?php echo (isset($info['active_name']) && ($info['active_name'] !== '')?$info['active_name']:''); ?>">
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">活动时间<span class="check-tips"><strong></strong></span></label>
			<div class="controls">
				<input type="text" name="application_time" class="text time" value="" placeholder="请选择申请时间" />-
				<input type="text" name="end_time" class="text time" value="" placeholder="请选择结束时间" />
			</div>
		</div>
		<div class="form-item">
			<label class="item-label">活动描述<span class="check-tips">（简单描述）</span></label>
			<div class="controls">
				<label class="textarea input-large">
					<textarea name="active_intro"><?php echo (isset($info['active_intro']) && ($info['active_intro'] !== '')?$info['active_intro']:''); ?></textarea>
				</label>
			</div>
		</div>
		<div class="form-item">
