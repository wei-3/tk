<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/owner\index.html";i:1507447502;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        <form action="<?php echo url('Owner/add'); ?>" method="post">
            ...
            <div class="form-group">
                <label>小区名(必填):</label>
                <input type="text" class="form-control" name="cell_name"/>
            </div>
            <div class="form-group">
                <label>你的房号(必填):</label>
