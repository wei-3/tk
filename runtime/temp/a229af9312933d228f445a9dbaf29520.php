<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/owner\index.html";i:1507283946;s:82:"D:\phpStudy\WWW\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="cf">
	<button class="btn ajax-post" target-form="ids" url="<?php echo url('Owner/setStatus',array('status'=>1)); ?>">审核通过</button>
	<button class="btn ajax-post" target-form="ids" url="<?php echo url('Owner/setStatus',array('status'=>0)); ?>">审核未通过</button>
...
<div class="data-table">
	<div class="data-table table-striped">
		<table class="">
			...
			<tr>
				<td><input class="ids" type="checkbox" name="ids[]" value="<?php echo $owner['id']; ?>" /></td>
				<td><?php echo $owner['id']; ?></td>
				<td><?php echo $owner['name']; ?></td>
				<td><?php echo $owner['tel']; ?></td>
				<td><?php echo $owner['number']; ?></td>
				<td><?php echo $owner['cell_name']; ?></td>
				<td><?php echo $owner['id_card']; ?></td>
				<td><?php echo $owner['relationship']; ?></td>
				<td><?php echo $owner['status_text']; ?></td>
				<td>
					<a title="编辑" href="<?php echo url('detail?id='.$owner['id']); ?>">查看详情</a>
					<a class="confirm ajax-get" title="删除" href="<?php echo url('del?id='.$owner['id']); ?>">删除</a>
				</td>
			</tr>
