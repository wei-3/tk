<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\WWW\twothink\public/../application/user/view/default/login\register.html";i:1506698407;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        <form>
            ...
            <div class="form-group">
                ...
                <a href="<?php echo url('login/index'); ?>" id="re">已有账号，立即登录</a>
            </div>
        </form>
    </div>
</div>
