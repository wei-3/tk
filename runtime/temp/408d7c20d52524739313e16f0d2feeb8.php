<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/sale\detail.html";i:1507363288;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<div class="main">
    ...
    <div class="container-fluid">
        ...
        <h4 class="text-danger">价格:<?php echo $info['price']; ?><?php echo $info['unit']; ?></h4>
        <div class="noticeDetailContent">
            <img src="<?php echo $info['path']; ?>" />
        </div>
    </div>
</div>
