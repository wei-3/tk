<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/index\index.html";i:1507292133;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
    ...
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('Service/service'); ?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo url('Property/property'); ?>">
