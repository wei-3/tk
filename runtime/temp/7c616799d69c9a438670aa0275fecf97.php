<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/service\service.html";i:1507447574;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    var loadPage=function (no) {
        $.get("<?php echo url('Active/ajaxpage'); ?>",{id:<?php echo $id; ?>,page:no},function (data) {
//            alert(data);
            $(".btn_load").remove();
            $('#content').append(data);
        });
