<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"D:\phpStudy\WWW\twothink\public/../application/home/view/default/property\my_property.html";i:1507449349;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
...
<script type="text/javascript">
    var loadPage=function (no) {
        $.get("<?php echo url('Property/ajaxpage'); ?>",{page:no},function (data) {
            $(".btn_load").remove();
            $('#content').append(data);
        })
    }
